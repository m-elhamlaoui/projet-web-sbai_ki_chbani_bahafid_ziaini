...
urlpatterns = [
    ...
    path('affiche_produits_admin/', views.affiche_produits_admin, name='affiche_produits_admin'),
    path('supprimer_produit/<int:id_produit>/', views.supprimer_produit, name='supprimer_produit'),
