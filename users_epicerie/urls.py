...
urlpatterns = [
    ...
    path(
        "ajouter_avis_produit/", views.ajouter_avis_produit, name="ajouter_avis_produit"
    ),
    path("recommander_produit/", views.recommander_produit, name="recommander_produit"),
    path(
        "ajouter_avis_service/", views.ajouter_avis_service, name="ajouter_avis_service"
    ),
    ...
    path(
        "affiche_conversation_action/",
        views.affiche_conversation_action,
        name="affiche_conversation_action",
    ),
    path("enregistrer_message/", views.enregistrer_message, name="enregistrer_message"),
    path(
        "utilisateurs_en_ligne/",
        views.utilisateurs_en_ligne,
        name="utilisateurs_en_ligne",
    ),
    path(
        "recherche_utilisateurs/",
        views.recherche_utilisateurs,
        name="recherche_utilisateurs",
    ),
    path("chat_admin/", views.chat_admin, name="chat_admin"),
    path("message/<int:user_id>/", views.message, name="message"),
    path(
        "affiche_conversation_admin/",
        views.affiche_conversation_admin,
        name="affiche_conversation_admin",
    ),
    path(
        "message_action_admin/", views.message_action_admin, name="message_action_admin"
    ),
]
